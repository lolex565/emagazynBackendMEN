...
router.route('/store').get((req, res) => {
    Store.find({}, 'storeId storeOldId storeName storeStatus storeLocation storeValue storeAmount')
...
router.route('/library').get((req, res) => {
    Library.find({}, 'libraryId libraryOldId libraryName libraryStatus libraryGenre libraryTarget libraryBorrowed libraryLocation')
